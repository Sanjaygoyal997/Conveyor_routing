...
check "Master data gap codes" \
  ...
  "DBM_NO_RUNNING_SIZE FORMAT_DRIFT MSL_DUPLICATE_ROW MSL_MATERIAL_NOT_RUNNABLE MSL_MULTI_RIM MSL_NONE_RIM MSL_NULL_AREA MSL_RIM_INACTIVE MSL_RIM_INVALID MSL_RIM_WRONG_AREA MSL_SIZE_NOT_RUNNING PROD_DUPLICATE_BARCODE PROD_MATERIAL_NO_SIZE RUN_RIM_INACTIVE RUN_RIM_WRONG_AREA"
