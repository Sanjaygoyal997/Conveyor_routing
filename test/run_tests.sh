...
check "WIP readiness per recipe/material (state 1, not yet at DBM)" \
  ...
  "100:OK:1 101:NG_AMBIGUOUS_SIZE:2 102:NG_RIM_INACTIVE:1 103:NG_RIM_NOT_IN_MASTER:1 104:NG_NO_EQUIPMENT_RUNNING:1 105:OK:1 106:NG_NO_MATERIAL_SIZE:1"
...
check "WIP rim demand vs running equipment" \
  ...
  "?:NG_UNRESOLVED:3 15:OK:1 16:INFO_NO_WIP:0 17:NG_NOT_RUNNING:1 18:OK:1 19:NG_NOT_RUNNING:1 20:NG_NOT_RUNNING:1 21:INFO_NO_WIP:0"

check "Master data gap codes" \
  "SELECT string_agg(DISTINCT check_code, ' ') FROM master.fn_rim_master_data_gaps()" \
  "DBM_NO_RUNNING_SIZE FORMAT_DRIFT MSL_CONFLICTING_SIZE MSL_DUPLICATE_ROW MSL_NULL_AREA MSL_RIM_INACTIVE MSL_RIM_MISSING MSL_SIZE_NOT_RUNNING PROD_DUPLICATE_BARCODE PROD_MATERIAL_NO_SIZE PROD_NO_RECIPE RUN_RIM_MISSING"
